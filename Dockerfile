...
COPY --from=stage1 /mariadb-apks/mariadb-common-10.3.7-r0.apk /mariadb-apks/mariadb-common-10.3.7-r0.apk
COPY --from=stage1 /mariadb-apks/mariadb-10.3.7-r0.apk /mariadb-apks/mariadb-10.3.7-r0.apk
COPY --from=stage1 /mariadb-apks/mariadb-client-10.3.7-r0.apk /mariadb-apks/mariadb-client-10.3.7-r0.apk
COPY ./rootfs /rootfs

RUN apk --no-cache --allow-untrusted add /mariadb-apks/mariadb-common-10.3.8-r0.apk /mariadb-apks/mariadb-10.3.8-r0.apk /mariadb-apks/mariadb-client-10.3.7-r0.apk \
